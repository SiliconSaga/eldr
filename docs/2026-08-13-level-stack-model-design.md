...
- **Cooling:** a void *above* the space engages solar. `cooling.attic_temp_f` sets it explicitly; otherwise a sol-air estimate from roof absorptance and the compass. This is the 4,406 vs 373 BTU/hr cooling gap.
